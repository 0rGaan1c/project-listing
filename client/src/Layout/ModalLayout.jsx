...
const ModalLayout = ({ children, width, isModal }) => {
  ...
  return (
    <>
      <div
        className={`${width} bg-white rounded-lg px-6 py-10 shadow-custom md:px-10 md:pt-16 md:pb-12 md:rounded-2xl
      ...
      >
        ...
        {isModal && (
          <div className="hidden lg:block lg:bg-[#36416A] text-white py-10 px-8 lg:col-span-2">
